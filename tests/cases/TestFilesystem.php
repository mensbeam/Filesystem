...
class TestFilesystem extends FilesystemTestCase {
    ...
    public function testChmodRecursive() {
        ...
        Fs::chmod($file, 0400, 0000, true);
        Fs::chmod($dir, 0753, 0000, true);
    ...
    public function testChmodChangesZeroModeOnSubdirectoriesOnRecursive() {
        ...
        Fs::chmod($directory, 0753, 0000, true);
    ...
    public function testChownSymlinkFails() {
        ...
        Fs::chown($link, 'user' . time() . mt_rand(1000, 9999));
    }
    ...
    public function testChownFail() {
        ...
        Fs::chown($dir, 'user' . time() . mt_rand(1000, 9999));
    }
    ...
    public function testChgrpSymlinkFails() {
        ...
        Fs::chgrp($link, 'user' . time() . mt_rand(1000, 9999));
    }
    ...
    public function testChgrpFail() {
        ...
        Fs::chgrp($dir, 'user' . time() . mt_rand(1000, 9999));
    }
    ...
    public function testDumpRemovesTmpFilesOnFailure() {
        ...
        $expected = scandir($parent, \SCANDIR_SORT_ASCENDING);

        try {
            Fs::dumpFile($parent . '/lib', 'bar');
            $this->fail('IOException expected.');
        } catch (IOException $e) {
            $this->assertSame($expected, scandir($parent, \SCANDIR_SORT_ASCENDING));
        }
    }
