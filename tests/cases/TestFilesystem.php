...
class TestFilesystem extends FilesystemTestCase {
    public static function providePathsForIsAbsolutePath() {
        $paths = [['/var/lib', true], ['var/lib', false], ['../var/lib', false], ['', false]];
    ...
    public static function providePathsForMakePathRelative() {
        $paths = [['/var/lib/symfony/src/Symfony/', '/var/lib/symfony/src/Symfony/Component', '../'], ['/var/lib/symfony/src/Symfony/', '/var/lib/symfony/src/Symfony/Component/', '../'], ['/var/lib/symfony/src/Symfony', '/var/lib/symfony/src/Symfony/Component', '../'], ['/var/lib/symfony/src/Symfony', '/var/lib/symfony/src/Symfony/Component/', '../'], ['/usr/lib/symfony/', '/var/lib/symfony/src/Symfony/Component', '../../../../../../usr/lib/symfony/'], ['/var/lib/symfony/src/Symfony/', '/var/lib/symfony/', 'src/Symfony/'], ['/aa/bb', '/aa/bb', './'], ['/aa/bb', '/aa/bb/', './'], ['/aa/bb/', '/aa/bb', './'], ['/aa/bb/', '/aa/bb/', './'], ['/aa/bb/cc', '/aa/bb/cc/dd', '../'], ['/aa/bb/cc', '/aa/bb/cc/dd/', '../'], ['/aa/bb/cc/', '/aa/bb/cc/dd', '../'], ['/aa/bb/cc/', '/aa/bb/cc/dd/', '../'], ['/aa/bb/cc', '/aa', 'bb/cc/'], ['/aa/bb/cc', '/aa/', 'bb/cc/'], ['/aa/bb/cc/', '/aa', 'bb/cc/'], ['/aa/bb/cc/', '/aa/', 'bb/cc/'], ['/a/aab/bb', '/a/aa', '../aab/bb/'], ['/a/aab/bb', '/a/aa/', '../aab/bb/'], ['/a/aab/bb/', '/a/aa', '../aab/bb/'], ['/a/aab/bb/', '/a/aa/', '../aab/bb/'], ['/a/aab/bb/', '/', 'a/aab/bb/'], ['/a/aab/bb/', '/b/aab', '../../a/aab/bb/'], ['/aab/bb', '/aa', '../aab/bb/'], ['/aab', '/aa', '../aab/'], ['/aa/bb/cc', '/aa/dd/..', 'bb/cc/'], ['/aa/../bb/cc', '/aa/dd/..', '../bb/cc/'], ['/aa/bb/../../cc', '/aa/../dd/..', 'cc/'], ['/../aa/bb/cc', '/aa/dd/..', 'bb/cc/'], ['/../../aa/../bb/cc', '/aa/dd/..', '../bb/cc/']];
        if ('\\' === \DIRECTORY_SEPARATOR) {
    ...
    public function testAppendToFile() {
        ...
        Fs::dumpFile($filename, 'foo');
        Fs::appendToFile($filename, 'bar');
    ...
    public function testAppendToFileFollowsSymlink() {
        ...
        Fs::symlink($filename, $linknameA);
        Fs::symlink($linknameA, $linknameB);
        Fs::appendToFile($linknameA, 'bar');
        Fs::appendToFile($linknameB, 'baz');
        $this->assertFileExists($filename);
    ...
    public function testAppendToFileWithResource() {
        ...
        fwrite($resource, 'bar');
        fseek($resource, 0);
        Fs::appendToFile($filename, $resource);
        $this->assertFileExists($filename);
        $this->assertStringEqualsFile($filename, 'foobar');
        // skip mode check on Windows
        if ('\\' !== \DIRECTORY_SEPARATOR) {
    ...
    public function testChgrpFail() {
        ...
        $dir = $this->workspace . \DIRECTORY_SEPARATOR . 'dir';
        mkdir($dir);
        Fs::chgrp($dir, 'user' . time() . random_int(1000, 9999));
    }
    ...
    public function testChgrpLinkFails() {
        ...
        touch($file);
        Fs::hardlink($file, $link);
        Fs::chgrp($link, 'user' . time() . random_int(1000, 9999));
    }
    ...
    public function testChmodChangesZeroModeOnSubdirectoriesOnRecursive() {
        ...
        Fs::chmod($directory, 0753, 00, true);
    ...
    public function testChmodRecursive() {
        ...
        $file = $dir . \DIRECTORY_SEPARATOR . 'file';
        touch($file);
        Fs::chmod($file, 0400, 00, true);
        Fs::chmod($dir, 0753, 00, true);
        $this->assertFilePermissions(753, $dir);
        $this->assertFilePermissions(753, $file);
    }
    ...
    public function testChownFail() {
        ...
        $dir = $this->workspace . \DIRECTORY_SEPARATOR . 'dir';
        mkdir($dir);
        Fs::chown($dir, 'user' . time() . random_int(1000, 9999));
    }
    ...
    public function testChownLinkFails() {
        ...
        touch($file);
        Fs::hardlink($file, $link);
        Fs::chown($link, 'user' . time() . random_int(1000, 9999));
    }
    ...
    public function testCopyForOriginUrlsAndExistingLocalFileDefaultsToCopy() {
        ...
        $process->setWorkingDirectory(__DIR__ . '/../etc/web');
        $process->start();
        do {
            usleep(50000);
        ...
        try {
            ...
            $targetFilePath = $this->workspace . \DIRECTORY_SEPARATOR . 'copy_target_file';
            file_put_contents($targetFilePath, 'TARGET FILE');
            Fs::copy($sourceFilePath, $targetFilePath, false);
            $this->assertFileExists($targetFilePath);
    ...
    public function testCopyOverridesExistingFileIfForced() {
        ...
        touch($sourceFilePath, $modificationTime);
        touch($targetFilePath, $modificationTime);
        Fs::copy($sourceFilePath, $targetFilePath, true);
        $this->assertFileExists($targetFilePath);
        $this->assertStringEqualsFile($targetFilePath, 'SOURCE FILE');
    }
    ...
    public function testDumpFileCleansUpAfterFailure() {
        ...
        Fs::touch($targetFile);
        Fs::chmod($targetFile, 0444);
        try {
            Fs::dumpFile($targetFile, 'any content');
        } catch (IOException $e) {
        } finally {
            Fs::chmod($targetFile, 0666);
        }
    ...
    public function testFilesExists() {
        ...
        $this->assertTrue(Fs::exists($basePath . 'file1'));
        $this->assertTrue(Fs::exists($basePath . 'folder'));
    }
    ...
    public function testFilesExistsFails() {
        ...
        $path = $basePath . $file;
        exec('TYPE NUL >>' . $file);
        // equivalent of touch, we cannot use the php touch() here because it suffers from the same limitation
    ...
    public function testFilesExistsTraversableObjectOfFilesAndDirectories() {
        ...
        $this->assertTrue(Fs::exists($files));
    }
    ...
    public function testFilesNotExistsTraversableObjectOfFilesAndDirectories() {
        ...
        $this->assertFalse(Fs::exists($files));
    }

    public function testInvalidFileNotExists() {
        $basePath = $this->workspace . \DIRECTORY_SEPARATOR . 'directory' . \DIRECTORY_SEPARATOR;
        $this->assertFalse(Fs::exists($basePath . time()));
    }

    #[DataProvider('providePathsForIsAbsolutePath')]
    public function testIsAbsolutePath($path, $expectedResult) {
        $result = Fs::isAbsolutePath($path);
    ...
    public function testMakePathRelative($endPath, $startPath, $expectedPath) {
        $path = Fs::makePathRelative($endPath, $startPath);
    ...
    public function testMakePathRelativeWithExistingFile() {
        ...
        $this->assertSame('foo/bar/test.txt', Fs::makePathRelative($file, $this->workspace));
        // Directory path must still get a trailing slash
        $this->assertSame('foo/bar/', Fs::makePathRelative($dir, $this->workspace));
    }
    ...
    public function testMakePathRelativeWithRelativeEndPath() {
        ...
        $this->assertSame('../../../', Fs::makePathRelative('var/lib/symfony/', '/var/lib/symfony/src/Symfony/Component'));
    }
    ...
    public function testMirrorAvoidCopyingTargetDirectoryIfInSourceDirectory() {
        ...
        if ('\\' !== \DIRECTORY_SEPARATOR) {
            Fs::symlink($targetPath, $sourcePath . 'target_simlink');
        }
        Fs::mirror($sourcePath, $targetPath, null, ['delete' => true]);
        $this->assertTrue(Fs::exists($targetPath));
        $this->assertTrue(Fs::exists($targetPath . 'directory'));
        $this->assertFileEquals($file1, $targetPath . 'directory' . \DIRECTORY_SEPARATOR . 'file1');
        $this->assertFileEquals($file2, $targetPath . 'file2');
        $this->assertFalse(Fs::exists($targetPath . 'target_simlink'));
        $this->assertFalse(Fs::exists($targetPath . 'target'));
    }
    ...
    public function testMirrorContentsWithSameNameAsSourceOrTargetWithDeleteOption() {
        ...
        Fs::mirror('source', 'target', null, ['delete' => true]);
        chdir($oldPath);
    ...
    public function testMirrorCopiesFilesAndDirectoriesRecursively() {
        ...
        $this->assertFileEquals($file2, $targetPath . 'file2');
        Fs::remove($file1);
        Fs::mirror($sourcePath, $targetPath, null, ['delete' => false]);
        $this->assertTrue(Fs::exists($targetPath . 'directory' . \DIRECTORY_SEPARATOR . 'file1'));
        Fs::mirror($sourcePath, $targetPath, null, ['delete' => true]);
        $this->assertFalse(Fs::exists($targetPath . 'directory' . \DIRECTORY_SEPARATOR . 'file1'));
        file_put_contents($file1, 'FILE1');
        Fs::mirror($sourcePath, $targetPath, null, ['delete' => true]);
        $this->assertTrue(Fs::exists($targetPath . 'directory' . \DIRECTORY_SEPARATOR . 'file1'));
        Fs::remove($directory);
        Fs::mirror($sourcePath, $targetPath, null, ['delete' => true]);
        $this->assertFalse(Fs::exists($targetPath . 'directory'));
        $this->assertFalse(Fs::exists($targetPath . 'directory' . \DIRECTORY_SEPARATOR . 'file1'));
    }
    ...
    public function testMirrorCopiesLinksByFollowingSymlinks() {
        ...
        symlink($sourcePath . 'file1', $sourcePath . 'link1');
        $targetPath = $this->workspace . \DIRECTORY_SEPARATOR . 'target' . \DIRECTORY_SEPARATOR;
        Fs::mirror($sourcePath, $targetPath, null, ['follow_symlinks' => true]);
        $this->assertDirectoryExists($targetPath);
        $this->assertFileEquals($sourcePath . 'file1', $targetPath . 'link1');
    ...
    public function testMirrorCopyOnWindowsOptionTriggersDeprecation() {
        $this->markAsSkippedIfSymlinkIsMissing();
        $this->expectUserDeprecationMessage('Since symfony/filesystem 8.1: Calling "MensBeam\Filesystem::mirror()" with option "copy_on_windows" is deprecated, use option "follow_symlinks" instead.');
        $sourcePath = $this->workspace . \DIRECTORY_SEPARATOR . 'source' . \DIRECTORY_SEPARATOR;
        mkdir($sourcePath);
        file_put_contents($sourcePath . 'file1', 'FILE1');
        symlink($sourcePath . 'file1', $sourcePath . 'link1');
        $targetPath = $this->workspace . \DIRECTORY_SEPARATOR . 'target' . \DIRECTORY_SEPARATOR;
        Fs::mirror($sourcePath, $targetPath, null, ['copy_on_windows' => true]);
        $this->assertDirectoryExists($targetPath);
        $this->assertFileEquals($sourcePath . 'file1', $targetPath . 'link1');
        $this->assertFalse(is_link($targetPath . \DIRECTORY_SEPARATOR . 'link1'));
    }
    ...
    public function testMirrorFollowSymlinksOverridesCopyOnWindows() {
        ...
        symlink($sourcePath . 'file1', $sourcePath . 'link1');
        $targetPath = $this->workspace . \DIRECTORY_SEPARATOR . 'target' . \DIRECTORY_SEPARATOR;
        Fs::mirror($sourcePath, $targetPath, null, ['follow_symlinks' => false, 'copy_on_windows' => true]);
        $this->assertDirectoryExists($targetPath);
        $this->assertFileEquals($sourcePath . 'file1', $targetPath . 'link1');
        $this->assertTrue(is_link($targetPath . \DIRECTORY_SEPARATOR . 'link1'));
    }
    ...
    public function testReadAbsoluteLink() {
        ...
        touch($file);
        Fs::symlink($file, $link1);
        Fs::symlink($link1, $link2);
        $this->assertEquals($file, Fs::readlink($link1));
        $this->assertEquals($link1, Fs::readlink($link2));
        $this->assertEquals($file, Fs::readlink($link1, true));
        $this->assertEquals($file, Fs::readlink($link2, true));
        $this->assertEquals($file, Fs::readlink($file, true));
    }
    ...
    public function testReadBrokenLink() {
        ...
        Fs::symlink($file, $link);
        Fs::remove($file);
        $this->assertEquals($file, Path::normalize(Fs::readlink($link)));
        $this->assertNull(Fs::readlink($link, true));
        touch($file);
        $this->assertEquals($file, Path::normalize(Fs::readlink($link, true)));
    }

    public function testReadDirectory() {
        $this->expectException(IOException::class);
        $this->expectExceptionMessageMatches(\sprintf('#^Failed to read file ".+%scases"\: File is a directory\.$#', preg_quote(\DIRECTORY_SEPARATOR)));
        Fs::readFile(__DIR__);
    }

    public function testReadFile() {
        $licenseFile = dirname(__DIR__, 2) . '/LICENSE';
        $this->assertStringEqualsFile($licenseFile, Fs::readFile($licenseFile));
    }
    ...
    public function testReadLinkCanonicalizePath() {
        ...
        touch($file);
        $this->assertEquals($file, Fs::readlink($this->normalize($this->workspace . '/dir/../file'), true));
    }

    public function testReadLinkCanonicalizedPathDoesNotExist() {
        $this->assertNull(Fs::readlink($this->normalize($this->workspace . 'invalid'), true));
    }

    public function testReadLinkDefaultPathDoesNotExist() {
        $this->assertNull(Fs::readlink($this->normalize($this->workspace . '/invalid')));
    }

    public function testReadLinkDefaultPathNotLink() {
        $file = $this->normalize($this->workspace . '/file');
        touch($file);
        $this->assertNull(Fs::readlink($file));
    }

    public function testReadNonExistentFile() {
        $this->expectException(IOException::class);
        $this->expectExceptionMessageMatches(\sprintf('#^Failed to read file ".+%1$scases/invalid"\: file_get_contents\(.+%1$scases/invalid\)\: Failed to open stream\: No such file or directory$#', preg_quote(\DIRECTORY_SEPARATOR)));
        Fs::readFile(__DIR__ . '/invalid');
    }
    ...
    public function testReadRelativeLink() {
        ...
        touch($file);
        Fs::symlink('../file', $link1);
        Fs::symlink('link', $link2);
        $this->assertEquals($this->normalize('../file'), Fs::readlink($link1));
        $this->assertEquals('link', Fs::readlink($link2));
        $this->assertEquals($file, Fs::readlink($link1, true));
        $this->assertEquals($file, Fs::readlink($link2, true));
        $this->assertEquals($file, Fs::readlink($file, true));
    }
    ...
    public function testRemoveCleansInvalidLinks() {
        ...
        Fs::symlink($basePath . 'dir/', $basePath . 'dir-link');
    ...
    public function testTempnam() {
        ...
        $filename = Fs::tempnam($dirname, 'foo');
        $this->assertFileExists($filename);
    }
    ...
    public function testTempnamOnUnwritableFallsBackToSysTmp() {
        ...
        $filename = Fs::tempnam($dirname, 'bar');
    ...
    public function testTempnamWithHTTPSchemeFails() {
        ...
        Fs::tempnam($dirname, 'bar');
    }

    public function testTempnamWithMockScheme() {
        stream_wrapper_register('mock', 'MensBeam\Filesystem\Test\MockStream');
        $scheme = 'mock://';
        $dirname = $scheme . $this->workspace;
        $filename = Fs::tempnam($dirname, 'foo');
        $this->assertStringStartsWith($scheme, $filename);
    ...
    public function testTempnamWithPharSchemeFails() {
        ...
        Fs::tempnam($dirname, $pharname . '/bar');
    }

    public function testTempnamWithSuffix() {
        $dirname = $this->workspace;
        $filename = Fs::tempnam($dirname, 'foo', '.bar');
    ...
    public function testTempnamWithSuffix0() {
        $dirname = $this->workspace;
        $filename = Fs::tempnam($dirname, 'foo', '0');
